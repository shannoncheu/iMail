...
const august2026Timestamp = (day: number, hour: number, minute: number) =>
...
const primaryThreads: MailThread[] = [
  {
    ...
    receivedAtMs: august2026Timestamp(18, 10, 42),
    unread: true,
    starred: true,
  ...
  },
  {
    ...
    receivedAtMs: august2026Timestamp(18, 9, 18),
    unread: true,
    starred: false,
    labels: ["Reading"],
  ...
  },
  {
    ...
    receivedAtMs: august2026Timestamp(18, 8, 41),
    unread: false,
    starred: false,
    labels: ["Travel"],
    hasExternalImages: true,
  ...
  },
  {
    ...
    receivedAtMs: august2026Timestamp(17, 18, 12),
    unread: false,
    starred: true,
  ...
  },
  {
    ...
    receivedAtMs: august2026Timestamp(17, 14, 3),
    unread: false,
    starred: false,
    labels: ["Security"],
    hasExternalImages: false,
  ...
  },
  {
    ...
    receivedAtMs: august2026Timestamp(17, 9, 20),
    unread: true,
    starred: false,
    labels: ["Studio"],
    hasExternalImages: false,
  ...
  },
  {
    ...
    receivedAtMs: august2026Timestamp(16, 20, 14),
    unread: false,
    starred: true,
    labels: ["Personal"],
    hasExternalImages: false,
  ...
  },
  {
    ...
    receivedAtMs: august2026Timestamp(12, 11, 32),
    unread: false,
    starred: false,
    labels: ["Receipts"],
    hasExternalImages: false,
  ...
  },
  {
    ...
    receivedAtMs: august2026Timestamp(11, 17, 4),
    unread: false,
    starred: false,
    labels: ["Studio"],
    hasExternalImages: false,
  ...
  },
  {
    ...
    receivedAtMs: august2026Timestamp(18, 8, 12),
    unread: false,
    starred: false,
    labels: ["Draft"],
    hasExternalImages: false,
...
const generatedThreads: MailThread[] = Array.from({ length: 24 }, (_, index) => {
  ...
  return {
    ...
    receivedAtMs: august2026Timestamp(day, 9 + (index % 8), 20),
    unread: index % 4 === 0,
    starred: index % 7 === 0,
